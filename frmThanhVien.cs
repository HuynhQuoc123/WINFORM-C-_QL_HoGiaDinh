...
namespace QL_HoGiaDinh
{
    ...
    public partial class frmThanhVien : Form
    {
        ...
        void ThucThiLuu()
        {
            ...
            if (blnThem)
            {
                dtThanhVien.Rows.Add(strHoGiaDinh, txtSTT.Text, txtHoTen.Text, Phai, dtpNgaySinh.Value,
                    txtQuanHe.Text, strNgheNghiep, strTrinhDo, strDoiTuong, strMatKhau, strQuyenSD);
                dgvThanhVien.CurrentCell = dgvThanhVien[0, dgvThanhVien.Rows.Count - 1];
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if ((blnThem) && (MyPublics.TonTaiHaiKhoaChinh(strMH, "MaHo", txtSTT.Text, "SttThanhVien", "ThanhVien")))
            {
