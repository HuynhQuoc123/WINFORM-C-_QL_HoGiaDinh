...
{
    public partial class frmThanhVienTheoTrinhDo : Form
    {
        ...
        int ViTri, ThemSua = 0;
        public frmThanhVienTheoTrinhDo()
        {
            InitializeComponent();
        }
        ...
        void DieuKhienKhiThem()
        {
            ...
            cboTrinhDo.SelectedIndex = ViTri;
...
/*              cboTrinhDo.SelectedValue = dgvThanhVien[7, dgvThanhVien.CurrentRow.Index].Value.ToString();*/
        ...
        void ThucThiLuu()
        {
            ...
            if (cboTrinhDo.SelectedIndex == ViTri)
            {
        ...
        private void frmThanhVienTheoTrinhDo_Load(object sender, EventArgs e)
        {
            string strSelect;
            NhanDuLieu();
            ...
            dvThanhVien.RowFilter = "MaTrinhDo =" + cboTrinhDo.SelectedValue;
            //data gird view
        ...
        {
            if (cboTrinhDo.SelectedIndex != -1 && ThemSua == 0)
            {
                dvThanhVien.RowFilter = "MaTrinhDo =" + cboTrinhDo.SelectedValue;
                dgvThanhVien.DataSource = dvThanhVien;
                GanDuLieu();
        ...
        {
            ThemSua = 1;
            ViTri = cboTrinhDo.SelectedIndex;
            DieuKhienKhiThem();
        }
