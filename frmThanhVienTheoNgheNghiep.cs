...
{
    public partial class frmThanhVienTheoNgheNghiep : Form
    {
        ...
        int ViTri, ThemSua = 0;
        public frmThanhVienTheoNgheNghiep()
        {
            InitializeComponent();
        }
        ...
        void ThucThiLuu()
        {
            ...
            if (cboNgheNghiep.SelectedIndex == ViTri)
            {
        ...
        private void ThanhVienTheoNgheNghiep_Load(object sender, EventArgs e)
        {
            string strSelect;
            NhanDuLieu();
            ...
            dvThanhVien.RowFilter = "MaNgheNghiep =" + cboNgheNghiep.SelectedValue;
            //data gird view
        ...
        private void btnChinhSua_Click(object sender, EventArgs e)
        {
            ...
            ThemSua = 2;
            ViTri = cboNgheNghiep.SelectedIndex;
        ...
        private void cboNgheNghiep_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cboNgheNghiep.SelectedIndex != -1 && ThemSua == 0)
            {
                dvThanhVien.RowFilter = "MaNgheNghiep =" + cboNgheNghiep.SelectedValue;
                dgvThanhVien.DataSource = dvThanhVien;
                GanDuLieu();
