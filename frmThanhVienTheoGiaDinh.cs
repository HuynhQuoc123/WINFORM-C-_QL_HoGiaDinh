...
{
    public partial class frmThanhVienTheoGiaDinh : Form
    {
        ...
        int ViTriHo, ThemSua = 0;
        public frmThanhVienTheoGiaDinh()
        {
            InitializeComponent();
        }
        ...
        void DieuKhienKhiThem()
        {
            ...
            cboHoGiaDinh.SelectedIndex = ViTriHo;
        ...
        void ThucThiLuu()
        {
            ...
            if(cboHoGiaDinh.SelectedIndex == ViTriHo)
            {
        ...
        private void frmThanhVienTheoGiaDinh_Load(object sender, EventArgs e)
        {
            string strSelect;
            NhanDuLieu();
            ...
            dvThanhVien.RowFilter = "MaHo =" + cboHoGiaDinh.SelectedValue;
            //data gird view
        ...
        private void cboHoGiaDinh_SelectedIndexChanged(object sender, EventArgs e)
        {
            if ((cboHoGiaDinh.SelectedIndex != -1) && (ThemSua == 0))
            {
                dvThanhVien.RowFilter = "MaHo =" + cboHoGiaDinh.SelectedValue;
                dgvThanhVien.DataSource = dvThanhVien;
                GanDuLieu();
        ...
        {
            ThemSua = 1;
            ViTriHo = cboHoGiaDinh.SelectedIndex;
            DieuKhienKhiThem();   
        }
